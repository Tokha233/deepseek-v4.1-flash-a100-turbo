...
class DSparkMarkovHead(nn.Module):
    ...
    def fusion_operands(
        ...
        elif logits_processor.head_dtype not in (None, w1.dtype) and not (
            logits_processor.head_dtype == torch.float32
            and w1.dtype == torch.bfloat16
            and w1.is_cuda
            and torch.cuda.get_device_capability(w1.device) == (8, 0)
        ):
